...
`npm run qa:routes` 若出现数据质量提示，按正式数据治理流程处理，不把它当成纯前端问题。2026-07-06 已清理过一轮历史提示：

- 企业 51-56 调研来源已补到 5 条以上。
- 企业 57-59 来源类型已改为推荐枚举。
- 院校 `ustc`、`ustb` 调研来源已补到 6 条以上。

后续如果再次出现同类提示，先核对来源强弱，不用百科、黄页或软文凑数。
