...
export const universities: University[] = [
  {
    ...
    overview: '北京理工大学国防特色明显，兵器科学、装备技术、智能系统和深造出口都强。',
    suitableFor: ['目标较高，关注办学层次和国防特色院校的学生。', '关注科研、竞赛、升学和军工体系发展的学生。'],
    reminders: ['报考热度通常较高，需要结合招生计划和近年录取位次判断。', '专业名称和培养方向按当年招生目录核对。'],
    links: [
      {
        title: '北京理工大学官网',
        type: '学校官网',
    ...
    research: {
      ...
      relevanceLevel: '高',
      conclusion: '北京理工大学层次高，机电学院公开页面显示兵器科学与技术、安全科学与工程等方向，对口兵器、装备和智能系统。大类、专业、省份计划和录取位次按当年本科招生网核对，别只看学校牌子。',
      keySignals: [
    ...
    "reminders": [
      ...
      "分省计划、专业组、录取分数和选科要求按当年招生网及省招办公布数据核对（待核对）。",
  ...
  },
  {
    ...
    overview: '中北大学有兵工传统，工程应用和军工就业线索集中。',
    ...
    research: {
      ...
      relevanceLevel: '高',
      conclusion:
        '中北大学本科招生网把弹药工程与爆炸技术列入兵器类，机电工程学院承接培养。报考按当年省份、批次、专业组和录取位次核对，就业去向要等官方就业材料，未核验不写成结论。',
      keySignals: [
  ...
  },
  {
    ...
    focus: '装备制造和兵器相关工程方向，东北区域就业资源集中。',
    tags: ['沈阳', '装备制造', '兵器相关', '东北'],
    overview: '沈阳理工大学主攻装备制造和兵器相关工程岗位，就业地域偏东北。',
    ...
    research: {
      ...
      relevanceLevel: '高',
      conclusion:
        '沈阳理工大学装备工程学院专业介绍列出弹药工程与爆炸技术、探测制导与控制技术、特种能源技术与工程等兵器类专业。报考按当年省份、批次和录取位次核对，就业材料未核验不写成结论。',
      keySignals: [
  ...
  },
  {
    ...
    focus: '兵工、光电和装备制造，西安军工产业资源集中。',
    tags: ['西安', '兵工背景', '装备制造', '区域资源'],
    overview: '西安工业大学对接西安军工资源，岗位集中在装备制造和工程技术。',
    ...
    research: {
      ...
      relevanceLevel: '中',
      conclusion:
        '西安工业大学本科招生网和兵器科学与技术学院页面可查到探测制导与控制技术、武器系统与工程等本科专业，区域军工和装备制造关联清楚。弹药方向匹配、招生计划、录取位次和就业去向逐年核对。',
      keySignals: [
    ...
    "research": {
      ...
      "relevanceLevel": "高",
      "conclusion": "安徽理工大学在安全工程、弹药工程与爆炸技术等方向有辨识度，对口民爆、应急安全和工程应用。分省计划、专业名称和录取数据按本科招生网核对，就业数据看学校官方最新报告（待核对）。",
      "keySignals": [
  ...
  },
  {
    ...
    "reminders": [
      "未把弹药工程与爆炸技术写成本科招生事实，专业口径按当年招生计划核对（待核对）。",
    ...
    "research": {
      ...
      "relevanceLevel": "中",
      "conclusion": "哈尔滨工程大学的国防装备、船海、核和航天方向对口军工装备场景，但本校没有把弹药工程与爆炸技术写成公开本科专业。先看装备、力学和安全相关入口，再按招生网核对当年专业大类、计划和录取数据。",
      "keySignals": [
  ...
  },
  {
    ...
    "research": {
      ...
      "relevanceLevel": "中",
      "conclusion": "西北工业大学的航空、航天、航海和国防装备方向对口军工装备场景，这里只当专业关联线索，不写成弹药工程本科招生。报考先查本科招生网，再按省份核对专业大类、计划、录取位次和就业报告。",
      "keySignals": [
  ...
  },
  {
    ...
    "research": {
      "updatedAt": "2026-06-08",
      "status": "官方入口已整理，招生和学院页面需继续核对。",
      "relevanceLevel": "中",
      "conclusion": "西南科技大学可作材料、安全工程和国防科工共建背景的对比院校，这些线索不写成弹药或爆炸技术本科招生。专业名称、分省计划和就业去向按本科招生网、教务入口和官方年度报告核对。",
      "keySignals": [
  ...
  },
  {
    ...
    "research": {
      ...
      "relevanceLevel": "高",
      "conclusion": "中国矿业大学的安全工程、矿业安全、工程力学和爆破安全场景对口明显，适合安全与矿业方向学生。研究方向不写成本科弹药专业，分省计划、录取数据和就业去向按本科招生网和官方报告核对。",
      "keySignals": [
  ...
  },
  {
    ...
    "research": {
      ...
      "status": "官方入口已整理，爆破和就业细分仍需逐项复核。",
      "relevanceLevel": "高",
      "conclusion": "中国矿业大学（北京）的安全工程、矿业安全、应急管理和工程安全场景对口较明确，爆破、爆炸力学只作核对线索，不写成本科弹药专业。专业、计划、分数和就业报告按招生网核对。",
      "keySignals": [
        "本科招生网可核对当年章程、计划、专业和录取信息。",
  ...
  },
  {
    ...
    "research": {
      ...
      "relevanceLevel": "高",
      "conclusion": "辽宁工程技术大学的安全工程、矿业安全、工程力学和工程爆破场景关联较强，适合作安全与爆破工程方向对比。爆破研究或工程场景不写成本科招生专业，专业、计划、录取和就业去向查官方年度材料。",
      "keySignals": [
  ...
  },
  {
    ...
    "research": {
      ...
      "relevanceLevel": "高",
      "conclusion": "河南理工大学的安全工程、矿业安全、灾害防控和应急管理方向对口较明确，适合作安全类工科院校对比。研究方向或行业场景不写成本科弹药专业，招生专业、计划、录取和就业去向查官方年度材料。",
      "keySignals": [
        "本科招生网可核对当年章程、计划、专业和录取信息。",
        "安全科学与工程学院提供安全工程、矿业安全和灾害防控方向入口。",
        "应急管理学院提供安全治理和应急方向入口。",
  ...
  },
  {
    ...
    "reminders": [
      ...
      "分省计划、专业组、选科要求和录取分数按当年招生网核对（待核对）。",
    ...
    "research": {
      ...
      "relevanceLevel": "中",
      "conclusion": "山东科技大学的安全工程、矿业安全和工程技术方向对口普通本科层次，工程安全线索保留，爆破或爆炸内容不写成本科弹药专业。招生、录取和就业去向按官方年度材料逐项核对。",
      "keySignals": [
        "本科招生网可核对当年章程、计划、专业和录取信息。",
  ...
  },
  {
    ...
    "research": {
      ...
      "status": "官方入口已整理，招生和学院页面需继续核对。",
      "relevanceLevel": "中",
      "conclusion": "太原理工大学可作 211 层次内安全工程、力学和能源工程方向对比。力学、能源或安全平台不写成弹药本科专业，专业、计划、录取和就业材料按本科招生网、教务入口和就业信息网核对。",
      "keySignals": [
        "本科招生网可核对当年章程、计划、专业和录取信息。",
  ...
  },
  {
    ...
    "research": {
      "updatedAt": "2026-06-08",
      "status": "官方入口已整理，招生、专业和就业数据需年度复核。",
      "relevanceLevel": "中",
      "conclusion": "昆明理工大学的安全工程、应急管理和防灾减灾方向对口西南安全类院校定位，安全工程不写成弹药或爆炸技术本科专业。招生计划、录取数据和就业去向按官方入口逐项核对，投递前先看专业目录。",
      "keySignals": [
        "本科招生网可核对当年章程、计划、专业和录取信息。",
  ...
  },
  {
    ...
    "research": {
      ...
      "risks": [
        ...
        "专业名称、招生省份和招生规模可能年度调整，按最新招生计划核对（待核对）。"
      ],
      "sources": [
        {
          "title": "沈阳工学院官网",
  ...
  },
  {
    ...
    "research": {
      ...
      "risks": [
        ...
        "分数线、招生人数、就业率和就业去向需按官方年度材料复核。",
        "不同学院方向和当年招生大类可能变化，按本科招生网最新材料核对（待核对）。"
      ],
      "sources": [
        {
          "title": "北京航空航天大学官网",
  ...
  },
  {
    ...
    "reminders": [
      "军校招生口径特殊，按当年本科招生网、招生计划和省级招办信息核对（待核对）。",
  ...
  },
  {
    ...
    "research": {
      ...
      "risks": [
        ...
        "招生人数、分数位次及教学报告按后续官方发布的最新文件核对（待核对）。",
        "研究生具体方向与名额受导师项目分配影响。"
      ],
      "sources": [
        {
